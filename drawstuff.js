...
function main() {
    ...
    var globals = { lightPos: new Vector(150,100,70),  // light over left upper rect
                    lightCol: new Color(255,192,203)}; // light color
    var tlAttribs = { diffuse: new Color(255,0,255)};    // all four rect verts blue
    var trAttribs = { diffuse: new Color(0,0,255)};
    var brAttribs = { diffuse: new Color(0,0,255)};
    var blAttribs = { diffuse: new Color(255,0,255)};
